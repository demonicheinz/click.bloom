  ...
  return (
    <div className="flex flex-col items-center space-y-4 border-b border-gray-100 bg-white px-6 py-8">
      ...
      <a 
        ...
        >
          <Image src="/social-icons/gmail.svg" alt="Email" width={34} height={34}/>
        </a>
        <a 
          ...
          className="transform transition-transform duration-200 hover:scale-125"
        >
          <Image src="/social-icons/github.svg" alt="GitHub" width={34} height={34}/>
        </a>
        <a 
          ...
          className="transform transition-transform duration-200 hover:scale-125"
        >
          <Image src="/social-icons/x.svg" alt="X" width={34} height={34}/>
        </a>
        <a 
          ...
          className="transform transition-transform duration-200 hover:scale-125"
        >
          <Image src="/social-icons/instagram.svg" alt="Instagram" width={34} height={34}/>
        </a>
      </div>
    </div>
  );
